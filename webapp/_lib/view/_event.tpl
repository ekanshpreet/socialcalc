<div id="eventsTable" class="left_panel">
    ...
    {/if}
    {if $flag}
    <h3 class="text_center"> Events for the Day {$date}/{$month}/{$year} </h3>
    ...
    {/foreach}
    {else}
        <h3 class="text_center">No Events for the Day {$date}/{$month}/{$year} </h3><hr>
    {/if}
</div>