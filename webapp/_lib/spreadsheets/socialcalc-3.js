...
SocialCalc.GetViewportInfo = function () {
   ...
   if (window.innerWidth) { // all but IE
      // [CHANGED FOR WEBAPP]
      result.width = 450+(.485*window.innerWidth);
      result.height = 1.4*window.innerHeight;
      ...
      if (document.documentElement && document.documentElement.clientWidth) {
         // [CHANGED FOR WEBAPP]
         result.width = 450+(.485*document.documentElement.clientWidth);
         result.height = 1.4*document.documentElement.clientHeight;
         ...
         // [CHANGED FOR WEBAPP]
         result.width = 450+(.485*document.body.clientWidth);
         result.height = 1.4*document.body.clientHeight;
